...
export const addPet = async (data) => {
  try {
    ...
    const response = await apiClient.post("/pet/addPet", data, {
        headers: {
...
export const deletePetById = async (petId) => {
  try {
    ...
    const response = await apiClient.delete(`/pet/deletePet/${petId}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
export const getUserById = async () => {
  try {
    ...
    const res = await apiClient.get(`/user/usuario`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
