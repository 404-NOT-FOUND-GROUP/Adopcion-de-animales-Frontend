...
import { useListarCitasActivas } from "../../shared/hooks/useListarCitasActivas";
import { useCompletarCita } from "../../shared/hooks/useCompletarCita";
import { NavBar } from "../../components/nav/NavBar";
import { Sidebar } from "../../components/nav/Sidebar";
import "../../components/UI/css/PetDetail.css";

export const CitasAceptadas = () => {
  const { citas, isLoading, fetchCitas } = useListarCitasActivas();
  const { completar, isLoading: loadingCompletar } = useCompletarCita();
                  ...
                  >
                    ...
                    >
                      <div style={{ flex: "0 0 220px", display: "flex", flexDirection: "column", alignItems: "center" }}>
                        ...
                        />
                        <button
                          className="btn btn-pet-primary mt-4"
                        ...
                        >
                          {loadingCompletar ? "Marcando..." : "Marcar como completada"}
                        </button>
                      </div>
